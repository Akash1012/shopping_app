...
import { AbcContext } from '../../contexts/abc-context';
...
const Header = (props) => {
    const { hidden, signOutStart } = props;
    const currentUser = useContext(CurrentUserContext);
    const { hiddens } = useContext(CartContext);
    const { akash, a } = useContext(AbcContext);
